programa {
  funcao inicio() {
    ...
    se(valor1 < valor2 e valor1 < valor3) {
      escreva("\nO primeiro valor digitado é o menor entre todos digitados!\n")
    } senao se(valor2 < valor1 e valor2 < valor3) {
      escreva("\nO segundo valor digitado é o menor entre todos digitados!\n")
    } senao {
      escreva("\nO terceiro valor digitado é o menor entre todos digitados!\n")
    }
  }
}
